...
import GenerateGiftCodesModal from "@/app/components/ui/GenerateGiftCodes";
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.map((plan) => (
                    ...
                    >
                        ...
                        {/* HEADER */}
                        <CardHeader className="pb-2 pr-12 p-8">
                            ...
                            <CardDescription className="text-xs text-muted-foreground mt-1">
                                Valid {plan.valid_days} days •{" "}
                                {plan.free_drinks} free drinks •{" "}
                        ...
                        <CardContent className="flex-1">
                            <div className="space-y-2 mt-2">
                                {plan.features.map((f, i) => (
                                    <div
                                        key={i}
                                        className="flex gap-3 border rounded-md p-2 bg-muted/30"
                                    >
                                        {f.icon_url ? (
                                            <img
                                                src={f.icon_url}
