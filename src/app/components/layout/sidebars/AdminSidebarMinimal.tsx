...
export function AdminSidebarMinimal({
    ...
    return (
        <motion.aside
            ...
            className="h-screen border-r flex flex-col bg-background overflow-hidden"
        >
            {/* Header */}
            ...
            <nav className="p-2 flex-1 space-y-1">
                ...
                <AnimatePresence>
                    {!collapsed && cafesOpen && (
                        ...
                        >
                            ...
                            <Link
                                href="/admin/dashboard/cafes/create/cafe"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Create Cafe
                            </Link>
                            <Link
                                href="/admin/dashboard/cafes/create/users"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Create Cafe Users
                            </Link>
                            <Link
                                href="/admin/dashboard/cafes/update/"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Update Cafe Users
                            </Link>
                ...
                <AnimatePresence>
                    {!collapsed && krownOpen && (
                        ...
                        >
                            <Link
                                href="/admin/dashboard/krown/banners"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Banners
                            </Link>
                            ...
                            <Link
                                href="/admin/dashboard/krown/influencers"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Influencers
                            </Link>
                            ...
                            <Link
                                href="/admin/dashboard/krown/home-sections"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Home Sections
                            </Link>
                            <Link
                                href="/admin/dashboard/krown/buzz"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Buzz Items
                            </Link>
                            <Link
                                href="/admin/dashboard/krown/overview"
                                className="block pl-8 py-1 text-sm hover:underline"
                            >
                                Home Preview
                            </Link>
            ...
            <div className="p-3 border-t">
                <button
                    className={
                        "flex items-center w-full gap-2 px-2 py-2 hover:bg-muted " +
